    ...
    if (height != null && weight != null) {
      setState(() {
        ...
        if (_calculation < 18.5) {
          _result = 'ANDA TERMASUK DALAM KATEGORI UNDERWEIGHT';
          ...
          _result = 'ANDA TERMASUK DALAM KATEGORI OVERWEIGHT';
        } else if (_calculation >= 30.0 && _calculation <= 34.9) {
          _result = 'ANDA TERMASUK DALAM KATEGORI OBESE CLASS 1';
        } else if (_calculation >= 35.0 && _calculation <= 34.9) {
          _result = 'ANDA TERMASUK DALAM KATEGORI OBESE CLASS 2';
        } else {
          _result = 'ANDA TERMASUK DALAM KATEGORI OBESE CLASS 3';
        }
      });
    }
  }
  ...
  Widget build(BuildContext context) {
    return new Scaffold(
      appBar: new AppBar(
        ...
        title: new Text('UTS Kalkulator BMI'),
      ),
      body: new ListView(
            ...
            child: new Column(
              ...
              children: <Widget>[
                ...
                new TextField(
                  ...
                  keyboardType: TextInputType.number,
                  decoration: new InputDecoration(
                      labelText: 'Masukkan Tinggi (Cm)', icon: new Icon(Icons.info)),
                ),
                new TextField(
